/*
实现了从Blender软件导出的3D模型文件中读取顶点、法线和面数据，
创建相应的MeshObject对象，并将材质信息与对象匹配，
最后将对象保存到文件中。
 * BlenderLoader.cpp
 *
...
//从材质库文件中加载材质信息，并将其分配给相应的MeshObject对象
